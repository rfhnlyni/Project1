...
for scene in scenes:
    ...
    for filename in bin_files:
        ...
        try:
            ...
            print(f"[OK] Scene {scene}: {filename} - {len(filtered_points)}/{len(points)} points kept (remission=0)")
    ...
    if processed_count > 0:
        ...
        print(f"Points kept (remission=0): {total_points_after}")
